...
<div class="box">
 <?php
    $nome = (isset($_GET['pagamento']) && $_GET['pagamento'] == 'concluido') ? 'Concluido' : 'Pendente';
 ?>
 ...
 <div class="wraper-table">
 	<table>
 		...
 		<!--inicio - da logica e conexão com banco de dados-->
        <?php
          if($nome == 'Pendente')
          	$nome = 0;
          else
 		...
 		<!--fim - da logica e conexão com banco de dados-->
 	</table>	
 </div>	
</div>