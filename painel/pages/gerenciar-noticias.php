...
<h2><i class="fa fa-id-card-o" arial-hidden="true"></i> Notícias Cadastradas</h2>

<table>
  <tr>
    <td><i class="fa fa-id-card-o" arial-hidden="true"> Título</td>
    <td>Categoria</td>	
  ...
  <tr>
    <td><?php echo $value['titulo']; ?></td><!--nome da coluna do bd (nome, data) de lá que vem as informações e vai para tela-->
    ...
    <td><a actionBtn="delete" class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL ?>gerenciar-noticias?excluir=<?php echo $value['id']; ?>"><i class="fa fa-times"> Excluir</i></a></td>
    <!--ordenamento-->
